...
use model\Client as ChildClient;
use model\ClientQuery as ChildClientQuery;
use model\Map\ClientTableMap;

/**
 * Base class that represents a query for the 'user_client' table.
 *
 *
 *
 * @method     ChildClientQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildClientQuery orderByUid($order = Criteria::ASC) Order by the uid column
 ...
 * @method     ChildClientQuery orderBySalt($order = Criteria::ASC) Order by the salt column
 ...
 * @method     ChildClientQuery orderByStatut($order = Criteria::ASC) Order by the statut column
 * @method     ChildClientQuery orderByDateCreation($order = Criteria::ASC) Order by the date_creation column
 * @method     ChildClientQuery orderByDateMaj($order = Criteria::ASC) Order by the date_maj column
 *
 * @method     ChildClientQuery groupById() Group by the id column
 * @method     ChildClientQuery groupByUid() Group by the uid column
 ...
 * @method     ChildClientQuery groupBySalt() Group by the salt column
 ...
 * @method     ChildClientQuery groupByStatut() Group by the statut column
 * @method     ChildClientQuery groupByDateCreation() Group by the date_creation column
 * @method     ChildClientQuery groupByDateMaj() Group by the date_maj column
 *
 ...
 * @method     ChildClient findOneByUid(string $uid) Return the first ChildClient filtered by the uid column
 ...
 * @method     ChildClient findOneBySalt(string $salt) Return the first ChildClient filtered by the salt column
 ...
 * @method     ChildClient findOneByStatut(int $statut) Return the first ChildClient filtered by the statut column
 * @method     ChildClient findOneByDateCreation(string $date_creation) Return the first ChildClient filtered by the date_creation column
 * @method     ChildClient findOneByDateMaj(string $date_maj) Return the first ChildClient filtered by the date_maj column
 *
 ...
 * @method     ChildClient[]|ObjectCollection findByUid(string $uid) Return ChildClient objects filtered by the uid column
 ...
 * @method     ChildClient[]|ObjectCollection findByPassword(string $password) Return ChildClient objects filtered by the password column
 * @method     ChildClient[]|ObjectCollection findBySalt(string $salt) Return ChildClient objects filtered by the salt column
 ...
 * @method     ChildClient[]|ObjectCollection findByStatut(int $statut) Return ChildClient objects filtered by the statut column
 * @method     ChildClient[]|ObjectCollection findByDateCreation(string $date_creation) Return ChildClient objects filtered by the date_creation column
 * @method     ChildClient[]|ObjectCollection findByDateMaj(string $date_maj) Return ChildClient objects filtered by the date_maj column
...
abstract class ClientQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \model\Base\ClientQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'custom_framework', $modelName = '\\model\\Client', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, uid, username, password, salt, nom, prenom, ville, statut, date_creation, date_maj FROM user_client WHERE id = :p0';
        try {
    ...
    public function filterByUid($uid = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClientTableMap::COL_UID, $uid, $comparison);
    }
    ...
    public function filterBySalt($salt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ClientTableMap::COL_SALT, $salt, $comparison);
    }
    ...
    public function filterByStatut($statut = null, $comparison = null)
    {
        if (is_array($statut)) {
            $useMinMax = false;
            if (isset($statut['min'])) {
                $this->addUsingAlias(ClientTableMap::COL_STATUT, $statut['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($statut['max'])) {
                $this->addUsingAlias(ClientTableMap::COL_STATUT, $statut['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ClientTableMap::COL_STATUT, $statut, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(ClientTableMap::COL_DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(ClientTableMap::COL_DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ClientTableMap::COL_DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateMaj($dateMaj = null, $comparison = null)
    {
        if (is_array($dateMaj)) {
            ...
            if (isset($dateMaj['min'])) {
                $this->addUsingAlias(ClientTableMap::COL_DATE_MAJ, $dateMaj['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateMaj['max'])) {
                $this->addUsingAlias(ClientTableMap::COL_DATE_MAJ, $dateMaj['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ClientTableMap::COL_DATE_MAJ, $dateMaj, $comparison);
    }
    ...
    /**
     * Deletes all rows from the user_client table.
     *
    ...
    {
        return $this->addUsingAlias(ClientTableMap::COL_DATE_MAJ, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ClientTableMap::COL_DATE_MAJ);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ClientTableMap::COL_DATE_MAJ);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ClientTableMap::COL_DATE_CREATION);
    }
    ...
    {
        return $this->addUsingAlias(ClientTableMap::COL_DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ClientTableMap::COL_DATE_CREATION);
    }
