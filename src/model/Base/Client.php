...
/**
 * Base class that represents a row from the 'user_client' table.
 *
 *
 *
...
abstract class Client implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\model\\Map\\ClientTableMap';
    ...
    /**
     * Initializes internal state of model\Base\Client object.
     */
     ...
     * @return $this|\model\Client The current object (for fluent API support)
     */
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[ClientTableMap::COL_UID] = true;
        }
    ...
    public function setSalt($v)
    {
        ...
        if ($this->salt !== $v) {
            $this->salt = $v;
            $this->modifiedColumns[ClientTableMap::COL_SALT] = true;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[ClientTableMap::COL_STATUT] = true;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            if ($dt !== $this->date_creation) {
                ...
                $this->modifiedColumns[ClientTableMap::COL_DATE_CREATION] = true;
            }
    ...
    public function setDateMaj($v)
    {
        ...
        if ($this->date_maj !== null || $dt !== null) {
            if ($dt !== $this->date_maj) {
                $this->date_maj = $dt;
                $this->modifiedColumns[ClientTableMap::COL_DATE_MAJ] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ClientTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ClientTableMap::translateFieldName('Username', TableMap::TYPE_PHPNAME, $indexType)];
            $this->username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ClientTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ClientTableMap::translateFieldName('Salt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ClientTableMap::translateFieldName('Nom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ClientTableMap::translateFieldName('Prenom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prenom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ClientTableMap::translateFieldName('Ville', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ville = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ClientTableMap::translateFieldName('Statut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->statut = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ClientTableMap::translateFieldName('DateCreation', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_creation = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ClientTableMap::translateFieldName('DateMaj', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 11; // 11 = ClientTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\model\\Client'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ClientTableMap::COL_DATE_CREATION)) {
                    $this->setDateCreation(time());
                }
                if (!$this->isColumnModified(ClientTableMap::COL_DATE_MAJ)) {
                    $this->setDateMaj(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ClientTableMap::COL_DATE_MAJ)) {
                    $this->setDateMaj(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_UID)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_SALT)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_STATUT)) {
        ...
        $sql = sprintf(
            'INSERT INTO user_client (%s) VALUES (%s)',
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\model\Client The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_UID)) {
            $criteria->add(ClientTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(ClientTableMap::COL_USERNAME)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_SALT)) {
            $criteria->add(ClientTableMap::COL_SALT, $this->salt);
        }
        if ($this->isColumnModified(ClientTableMap::COL_NOM)) {
        ...
        if ($this->isColumnModified(ClientTableMap::COL_STATUT)) {
            $criteria->add(ClientTableMap::COL_STATUT, $this->statut);
        }
        if ($this->isColumnModified(ClientTableMap::COL_DATE_CREATION)) {
            $criteria->add(ClientTableMap::COL_DATE_CREATION, $this->date_creation);
        }
        if ($this->isColumnModified(ClientTableMap::COL_DATE_MAJ)) {
            $criteria->add(ClientTableMap::COL_DATE_MAJ, $this->date_maj);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \model\Client (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \model\Client Clone of current object.
     * @throws PropelException
     */
