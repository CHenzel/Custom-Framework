...
*/
abstract class Livre implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\model\\Map\\LivreTableMap';
    ...
    /**
     * Initializes internal state of model\Base\Livre object.
     */
    ...
    /**
     * Compares this with another <code>Livre</code> instance.  If
     * <code>obj</code> is an instance of <code>Livre</code>, delegates to
     * <code>equals(Livre)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Livre The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LivreTableMap::COL_ID] = true;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[LivreTableMap::COL_NOM] = true;
        }
    ...
    public function setPrix($v)
    {
        ...
        if ($this->prix !== $v) {
            $this->prix = $v;
            $this->modifiedColumns[LivreTableMap::COL_PRIX] = true;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            if ($dt !== $this->date_creation) {
                ...
                $this->modifiedColumns[LivreTableMap::COL_DATE_CREATION] = true;
            }
        } // if either are not null
    ...
    public function setDateMaj($v)
    {
        ...
        if ($this->date_maj !== null || $dt !== null) {
            if ($dt !== $this->date_maj) {
                $this->date_maj = $dt;
                $this->modifiedColumns[LivreTableMap::COL_DATE_MAJ] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LivreTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLivreQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLivreQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(LivreTableMap::COL_DATE_MAJ)) {
                    $this->setDateMaj(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(LivreTableMap::COL_DATE_MAJ)) {
                    $this->setDateMaj(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                LivreTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LivreTableMap::COL_ID)) {
    ...
    {
        $pos = LivreTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Livre'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Livre'][$this->hashCode()] = true;
        $keys = LivreTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNom(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\model\Livre The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(LivreTableMap::DATABASE_NAME);

        if ($this->isColumnModified(LivreTableMap::COL_ID)) {
            $criteria->add(LivreTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LivreTableMap::COL_NOM)) {
        ...
        if ($this->isColumnModified(LivreTableMap::COL_DATE_MAJ)) {
            $criteria->add(LivreTableMap::COL_DATE_MAJ, $this->date_maj);
        }
    ...
    {
        $criteria = ChildLivreQuery::create();
        $criteria->add(LivreTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \model\Livre (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \model\Livre Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LivreTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildLivre The current object (for fluent API support)
     */
